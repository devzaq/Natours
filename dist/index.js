...
})({"9eecw":[function(require,module,exports,__globalThis) {
...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./mapbox":"3zDlz"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
const login = async (email, password)=>{
    try {
        ...
        console.log(error.response?.data.message || error.message); // Added error fallback
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9eecw","f2QDv"], "f2QDv", "parcelRequire11c7")
