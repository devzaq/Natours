...
})({"icqFP":[function(require,module,exports,__globalThis) {
...
if (formUserData) document.querySelector('.form-user-data').addEventListener('submit', (e)=>{
    e.preventDefault();
...
if (formUserSettings) document.querySelector('.form-user-settings').addEventListener('submit', async (e)=>{
    e.preventDefault();
...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./mapbox":"3zDlz","./updateSettings":"l3cGY","./stripe":"10tSC"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
const login = async (email, password)=>{
    try {
        ...
        (0, _alerts.showAlert)('error', error.response?.data.message || error.message); // Added error fallback
    }
};
const logout = async ()=>{
    try {
...
},{"./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}],"6Mcnf":[function(require,module,exports,__globalThis) {
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2emFxIiwiYSI6ImNtOGUwd2x2cTJmaWwycnM4NG8wNDF5dmsifQ.hIsuLN8nYbvOXUreUsCXWQ';
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === 'success') (0, _alerts.showAlert)('success', `${type.at(0).toUpperCase() + type.slice(1)} updated successfully!`);
    } catch (error) {
        (0, _alerts.showAlert)('error', error.response?.data.message || error.message); // Added error fallback
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf","axios":"jo6P5"}],"10tSC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe('pk_test_51R6DglBbphT2o3hlEbU8w4po88MoQmMOOpem9dhDIGD6uqP1AfJEzq0ENkjhF5iIMMQmV6o10hnbzwXDvKR6BMe000zFt2INIP');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf","axios":"jo6P5"}]},["icqFP","f2QDv"], "f2QDv", "parcelRequire11c7")
